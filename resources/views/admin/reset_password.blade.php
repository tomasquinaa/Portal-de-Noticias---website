                        ...
                        <div class="card card-primary border-box">
                            ...
                            <div class="card-body card-body-auth">
                                <form method="POST" action="{{ route('admin_reset_password_submit')}}">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control @error('retype_password') is-invalid @enderror" name="retype_password" placeholder="Digite novamente a password" value="" autofocus>
